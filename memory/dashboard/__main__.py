# -*- coding: utf-8 -*-
"""CLI: python -m memory.dashboard serve --workdir PATH --port 8110."""
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    sp = sub.add_parser("serve", help="Поднять uvicorn на 127.0.0.1:8110")
    sp.add_argument("--workdir", type=Path, default=None, help="Корень с .agent/")
    sp.add_argument("--port", type=int, default=None, help="Порт (по умолчанию 8110)")

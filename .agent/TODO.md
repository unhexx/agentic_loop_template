...
- [x] P4-META-01: Execute full meta flow on bootstrap (harvest using a mock or real handoff from init, analyze, propose at least 1 safe improvement e.g. "add metrics compression example", apply-safe). Record trajectory. (Partial: harvested T-001-03f8 with high conf, added success_patterns for metrics/ledger; analyze needs heuristic enhancement)
